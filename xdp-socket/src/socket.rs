    ...
    Socket<t>: Seek_<t>,
{
    ...
    /// Peeks at a buffer for the descriptor at `x_head`.
    ...
    /// Seeks the next available descriptor in the ring.
    ///
    /// This is a convenience method that calls the direction-specific `seek_` method.
